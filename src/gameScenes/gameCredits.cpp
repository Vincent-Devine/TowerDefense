...
void GameCredits::Start()
{
    ...
    mTextToDisplay[1] = "by:";
    mTextToDisplay[2] = "DEVINE Vincent,";
    mTextToDisplay[3] = "ZALLIO Liam,";
    mTextToDisplay[4] = "MAZURIE Florestan.";
    mTextToDisplay[5] = "Powered by RayLib.";

    mTextToDisplay[6] = "Graphics are free of rights.";
    mTextToDisplay[7] = "This is a school project made in 3 weeks.";
